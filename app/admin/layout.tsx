...
export default function AdminLayout({
  ...
  const navigation = [
    ...
    { name: 'Todos', href: '/admin/todos', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
    ...
    { name: 'RAG Management', href: '/admin/rag', icon: 'M12 6V4m0 2a2 2 0 100 4 2 2 0 000-4zm0 2a2 2 0 100 4 2 2 0 000-4zm6-8a9 9 0 11-18 0 9 9 0 0118 0zm-9 5a4 4 0 100-8 4 4 0 000 8z' },
    { name: 'Groq API Usage', href: '/admin/groq', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  ];
